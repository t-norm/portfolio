        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I fell in love with programming after helping an employer revamp their client site and haven't looked back!
              <br />
              <br />I am fluent in foundational web dev. languages such as
              <i>
                <b className="purple"> HTML, Javascript, and CSS. </b>
              </i>
              <br />
              <br />
              My interests are in building new &nbsp;
              <i>
                <b className="purple">web technologies and products, </b> and
                technology related to{" "}
                <b className="purple">
                  maintaining, updating, and refining web applications.
                </b>
              </i>
              <br />
              <br />
